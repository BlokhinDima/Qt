    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this, &MainWindow::sig_DataReady, this, &MainWindow::sl_DisplayData);
}
...
void MainWindow::sl_DisplayData(QVector<int> x, QVector<double> y)
{
    chartWindow->DisplayData(x, y);
    chartWindow->show();
}
